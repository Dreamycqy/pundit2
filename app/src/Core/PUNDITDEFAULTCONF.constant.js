...
.constant('PUNDITDEFAULTCONF', {
     ...
     */
    useTemplates: false, //hujiawei true
     ...
     */
    useBasicRelations: false, //hujiawei true
    ...
    modules: {
        ...
        CoreItemsContainer: {
            // ngdoc in CoreItemsContainer.service.js
            active: true
        },
